...
function getFallbackData(sheet, params = {}) {
  switch (sheet) {
    ...
    case API.SHEETS.FAQ: {
      const section = params.section;
      const all = [
        { id: 'F01', question_ms: 'Siapakah yang layak menyertai persidangan ini?', question_en: 'Who is eligible to participate in this conference?', answer_ms: 'Persidangan ini terbuka kepada semua pegawai Bahagian Penguatkuasaan Farmasi, agensi penguatkuasaan jemputan, dan rakan strategik yang dilantik oleh urus setia.', answer_en: 'This conference is open to all Pharmacy Enforcement Division officers, invited enforcement agencies, and strategic partners appointed by the secretariat.', section: 'main' },
        { id: 'F02', question_ms: 'Di manakah lokasi persidangan?', question_en: 'Where is the conference venue?', answer_ms: 'Persidangan diadakan di Hotel KSL Esplanade, Klang, No. 1, Persiaran Bestari 2/KS09, Bandar Bestari, 41200 Klang, Selangor, Malaysia.', answer_en: 'The conference is held at KSL Esplanade Hotel, Klang, No. 1, Persiaran Bestari 2/KS09, Bandar Bestari, 41200 Klang, Selangor, Malaysia.', section: 'main' },
