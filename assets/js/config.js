...
export const RISE = Object.freeze({
  ...
  /** Full name */
  fullname_ms: 'Research, Innovation, Science & Excellence Symposium',
  fullname_en: 'Research, Innovation, Science & Excellence Symposium',
  ...
  categories: Object.freeze([
    {
      ...
      label_ms:   'Kategori 1',
      label_en:   'Category 1',
      title_ms:   'Pembentangan Poster R&D',
      title_en:   'R&D Poster Presentation',
      ...
      detail_ms:  'Saiz: A0 · Papan: A0 Board · Format: Pertandingan',
      detail_en:  'Size: A0 · Board: A0 Board · Format: Competition',
    },
    {
      id:         'kolokium',
      num:        '02',
      label_ms:   'Kategori 2',
      label_en:   'Category 2',
      title_ms:   'Kolokium Poster R&D',
      title_en:   'R&D Poster Colloquium',
      ...
      detail_ms:  'Saiz: A0 · Papan: A0 Board · Format: Perkongsian',
      detail_en:  'Size: A0 · Board: A0 Board · Format: Sharing',
    },
    {
      id:         'qip',
      num:        '03',
      label_ms:   'Kategori 3',
      label_en:   'Category 3',
      title_ms:   'Projek Inisiatif Penambahbaikan Kualiti',
      title_en:   'Quality Improvement Initiative Project',
      type_ms:    'Pertandingan',
      type_en:    'Competition',
      method_ms:  'Pameran Projek',
      method_en:  'Project Exhibition',
      desc_ms:    'Pameran projek inisiatif penambahbaikan kualiti menggunakan shell scheme booth. Setiap booth dikongsi oleh 2 pempamer.',
      desc_en:    'Exhibition of quality improvement initiatives using shell scheme booths. Each booth is shared by 2 exhibitors.',
      detail_ms:  'Booth: Shell Scheme 3m × 3m · 2 pempamer setiap booth',
      detail_en:  'Booth: Shell Scheme 3m × 3m · 2 exhibitors per booth',
    },
  ]),
